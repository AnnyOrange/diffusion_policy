...
def optimize_waypoint_selection(
    ...
    waypoints = list(set(waypoints))
    waypoints.sort()
    distance,_ = func(actions = actions,gt_states=gt_states, waypoints=waypoints, all_distance=all_distance)
    # print(
...
def get_obj_func(waypoints_count, smooth, i, s_coeff=10): # 0.2
    # 0*inf is nan  a
    # print("waypoints_count",waypoints_count)s
    # print("i",i)
    # print("smooth",smooth)
